    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                ...
                <small class="float-right"><a href="add_p.php"> <button type="button" class="btn btn-block btn-primary">Add Produto</button></a>    </small>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      ...
      <div class="modal-body">
        <p>Tem certeza que deseja excluir essa distribuidora?</p>
      </div>
